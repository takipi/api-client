...
public class SystemMetricGraphRequest extends TimeframeRequest implements ApiGetRequest<SystemMetricGraphResult> {
	...
	private SystemMetricGraphRequest(String serviceId, String metricName, String from, String to,
			int wantedPointCount, GraphResolution resolution,
	...
	public static class Builder extends TimeframeRequest.Builder {
		...
		public SystemMetricGraphRequest build() {
			...
			return new SystemMetricGraphRequest(serviceId, metricName, from, to,
					wantedPointCount, resolution, servers, apps, deployments);
		}
	}
}
