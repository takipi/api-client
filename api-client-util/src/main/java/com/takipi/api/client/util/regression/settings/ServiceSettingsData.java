...
public class ServiceSettingsData
{
	...
	/**
	 * A list of pattern groups that defined key business transaction that can be specifically 
	 * reported on and visualized within Grafana dashboards. For example, a user may defined all
	 * servlets within a target set of packages as having key importance to the reliability of the applications
	 * and as such would like to be able to report specifically on any new errors, regressions and slowdowns within them..
	 */
	 ...
	 * based on the number of severe and non severe new events, regressions and slowdowns occuring within it
