...
public class RegressionSettings {
	 ...
	 * whose type is contained in the list, it will be considered a severe new issues, regardless
	 * of whether it exceeded the error_min_rate_threshold and error_min_volume_threshold settings. For example,
	 * a *new* NullPointerException may be considered severe, regardless of whether .or not it exceeded the minimal
	 * volume thresholds.
	 */
