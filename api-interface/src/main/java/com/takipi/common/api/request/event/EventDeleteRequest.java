...
public class EventDeleteRequest extends ServiceRequest implements ApiPostRequest<EmptyResult> {
	private final String eventId;

	EventDeleteRequest(String serviceId, String eventId) {
		super(serviceId);
	...
	public static class Builder extends ServiceRequest.Builder {
		...
		public EventDeleteRequest build() {
			...
			return new EventDeleteRequest(serviceId, eventId);
		}
	}
}
